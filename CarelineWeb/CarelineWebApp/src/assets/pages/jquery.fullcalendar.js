...
!function ($) {
    ...
    CalendarApp.prototype.onSelect = function (start, end, allDay) {
        ...
        var body = $("#event-modal .modal-body").html();
        $this.$modal.find('.delete-event').hide().end().find('.save-event').show().end().find('.modal-body').empty().prepend(body).end().find('.save-event').unbind('click').click(function () {
            form.submit();
        });
        $this.$modal.find('form').on('submit', function () {
